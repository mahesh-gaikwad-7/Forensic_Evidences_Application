                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-12 mx-auto">
                            <form class="custom-form login-form" action="Hosp_Login" role="form" method="post">
                                <h3 class="hero-title text-center mb-4 pb-2">Hospital Login Form</h3>
                                ...
                                <div class="row justify-content-center align-items-center">
                                    ...
                                    <div class="col-lg-5 col-12">
                                        <a href="Hospital_Register.jsp" class="btn custom-btn custom-border-btn">Register</a>
                                    </div>
                                </div>
