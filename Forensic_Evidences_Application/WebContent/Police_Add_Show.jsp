                ...
                <div class="container">
                    <div class="row justify-content-between">
                        ...
                        <div class="col-lg-12 col-12 d-flex">
                            ...
                            <div>
                                 <a href="Police_Add_Show.jsp" class="custom-btn custom-border-btn btn">Add Info
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12 mx-auto">
                            ...
                            <form class="custom-form" role="form" action="police_info" method="post">
                                 <div  style="width: 100%">
                                   ...
                                   <h3 class="hero-title text-center mb-4 pb-2">Create an account</h3>
                                    ...
                                    <table style="width: 100%">
										<tr>
											...
											<select class="form-control" required="required" name="crime" id="gender">
                                          <option value="" >Select Types of crime</option>
                                          <option value="Cybercrime">Cybercrime</option>
                                          <option value="Financial_crimes">Financial crimes</option>
                                          <option value="Car_crimes">Car crimes</option>
                                           <option value="Other_crimes">Other crimes</option>
                                          <option value="No_crimes">No crimes</option>
                                       </select>
									 </div>
											</td>
