                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12 mx-auto">
                            <form class="custom-form" role="form" action="addpatientinfo"  method="post">
                                 <div  style="width: 100%">
                                 <br/>
                                 <br/>
                               ...
                               <table style="width: 100%">
										<tr>
											...
											<select class="form-control" name="Blood_Group" id="Info"
												required="required">
													<option value="">Select Blood Group Info</option>
